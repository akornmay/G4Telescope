...
//
//
// $Id: pixelTBDetectorMessenger.cc,v 1.12 2008-09-22 16:41:20 maire Exp $
...
pixelTBDetectorMessenger::pixelTBDetectorMessenger(pixelTBDetectorConstruction* myDet)
:myDetector(myDet)
{ 
...
pixelTBDetectorMessenger::~pixelTBDetectorMessenger()
{
  delete TargMatCmd;
  delete ChamMatCmd;
  delete FieldCmd;
...
void pixelTBDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{ 
